...
通常情况下, 周一, 周三, 周五 晚上8点上课.  但是为了课程完整性, 以及一些特殊情况. 会有调整. **各位一定要注意群公告**. 有些人习惯性把群屏蔽.  请把"樵夫", "lucky"设置为**关注的群成员**.  这样避免遗漏掉最新的通知. 
...
现阶段 ,爬虫入门, js, js逆向 -> 小鹅通 ,  

沛齐阶段, app逆向部分 -> 老师安排 -> 腾讯会议.

Python基础 -> 回顾: 樵夫 2节课.  周五尽量不要缺席

课程前期:  爬虫基础,  lucky老师

课程中期:  JavaScript, 网页逆向. lucky老师

 ->  3个月

课程后期: app逆向. 沛齐老师  -> 腾讯会议|小鹅通
